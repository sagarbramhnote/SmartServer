    	  ...
    	  //Adding Distinct denominations in to a set like $1,$2,...
    	   ...
    	   i+=2;
		     ...
		     cell.setCellStyle(fullBold);
		      ...
		      workbook.write(out);
		      if(!toDay) {
		      OutputStream fileOut = new FileOutputStream("C:\\Users\\Bezwada\\Desktop\\newEODReport.xlsx");
		      workbook.write(fileOut);
		      }else {
		    	  OutputStream fileOut = new FileOutputStream("C:\\Users\\Bezwada\\Desktop\\TodayEODReport.xlsx");
			      workbook.write(fileOut);
		      }
